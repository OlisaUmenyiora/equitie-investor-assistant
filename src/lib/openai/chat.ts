...
- Never use em dashes or en dashes anywhere in your replies. Use commas, colons, or parentheses instead.
...
/**
 * Guarantee no em dashes (or en dashes used as separators) reach the UI, regardless
 * of what the model produced. A spaced dash becomes a comma; a bare dash becomes a
 * hyphen so ranges/compounds still read sensibly.
 */
